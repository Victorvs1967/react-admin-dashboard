  ...
  return (
    <ItemContainer>
      ...
      <UserContainer>
        <ShowUser>
          <ShowUserTop>
            <ItemShowImg src="https://randomuser.me/api/portraits/women/77.jpg" alt="show-image" />
            <ShowTopTitle>
              <FontWeight bolder>Rebecca Parker</FontWeight>
              <FontWeight bolder>UX Designer</FontWeight>
            </ShowTopTitle>
          </ShowUserTop>
          <ShowUserBottom>
        ...
        <UpdateUser>
          ...
          <UpdateForm>
            ...
            <UpdateRight>
              <ItemUpload>
                <ItemUploadImg src="https://randomuser.me/api/portraits/women/77.jpg" alt="upload-img" />
                <label htmlFor="file">
                  <MyPublish />
                </label>
